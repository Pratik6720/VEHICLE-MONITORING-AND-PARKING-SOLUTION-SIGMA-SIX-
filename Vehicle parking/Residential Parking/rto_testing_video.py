...
def checkValue(plate_value):
    try:
        ...
        cursor.execute("SELECT sr_no , reg_name , no_plate , mobile_number,alloted_slot from resident")
        ...
        for row in rows:
            if plate_value == row[2]:
                ...
                rt1 = cursor.execute("SELECT sr_no , reg_name , no_plate , mobile_number,alloted_slot from resident")
                print("----------------------------------------")
